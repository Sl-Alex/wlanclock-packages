...
class AbstractCanvas
{
    public:
        ...
        int  drawText(const Config::Fonts::Params &params, std::string text, rgba32_t color);
        int  drawText(const Config::Fonts::Params &params, std::wstring text, rgba32_t color);
